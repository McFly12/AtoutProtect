	...
	<div class="container pt" style="margin-bottom:-5%;">
		<div class="row mt">
			<div class="col-lg-6 col-lg-offset-3 centered" style="margin-top:-5%;">
				...
				<hr>
				<p>Veuillez compléter le champ suivant :</p>
			</div>
		</div>
		<div class="row mt">
			<div class="col-lg-8 col-lg-offset-2" style="margin-top:-32px;">
				<form method="POST" action="modules/resetmdp.php">
				  <div class="form-group">
				    <input type="email" class="form-control" id="mail_reset_mdp" name="mail_reset_mdp" placeholder="Adresse email" autocomplete="off">
				    <br>
				  </div>
				    <br>
            <button class="btn btn-success" type="submit" style="margin:auto;display:block;">
