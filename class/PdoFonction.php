...
class PdoFonction extends PdoBdd {
	...
	public function VerifierLogin($mail,$mdp){
		parent::connexion();
		$result = parent::requete('	SELECT U.Nom,U.Prenom,U.Droit,U.id
																FROM utilisateur U
	...
	public function InformationsUtilisateur($nom) {
		parent::connexion();
		$result = parent::requete('SELECT U.Prenom,U.Tel,U.Email,U.Mdp,U.Adresse,U.CodePostal,U.Ville,U.Droit,U.DateDeCreation,U.DateDerniereConnexion,U.HeureDerniereConnexion
															 FROM utilisateur U
															 WHERE U.Nom = "'.$nom.'"');
		parent::deconnexion();
		return $result;
